            ...
            if (isEditing && deckId) {
                try {
                    ...
                    reset({
                        ...
                        front_label: deck.front_label || 'Question',
                        back_label: deck.back_label || 'Answer',
        ...
        <div className="max-w-2xl mx-auto p-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="front_label" className="block text-sm font-medium text-gray-700">
                            Front Side Label
                        </label>
                        <input
                            id="front_label"
                            {...register('front_label')}
                            placeholder="Question"
                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border"
                        />
                        <p className="mt-1 text-xs text-gray-500">Default: "Question". For language cards, you might use "Spanish"</p>
                    </div>
                    <div>
                        <label htmlFor="back_label" className="block text-sm font-medium text-gray-700">
                            Back Side Label
                        </label>
                        <input
                            id="back_label"
                            ...
                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border"
                        />
                        <p className="mt-1 text-xs text-gray-500">Default: "Answer". For language cards, you might use "English"</p>
                    </div>
                </div>
